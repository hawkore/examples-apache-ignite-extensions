...
public class City {
    ...
    @QueryTextField(geoShapeMappers = {
            ...
            @GeoShapeMapper(name = "place_centroid", column="shape", transformations = @GeoTransformation(type = GeoTransformationType.CENTROID), max_levels = 15),
            @GeoShapeMapper(name = "place_buffer", column="shape", transformations = @GeoTransformation(type = GeoTransformationType.BUFFER, max_distance = "50km"))
    })
    @QuerySqlField
